...
public class ImageWithArray {
    ...
    public static void main(String[] args) {
        ...
        BufferedImage bf = readImage("C:\\Users\\xh\\Pictures\\ggg1.png");//这里写你要读取的绝对路径+文件名
        ...
        writeImageFromArray("C:\\Users\\xh\\Pictures\\2.png", "png", rgbArray1);//这里写你要输出的绝对路径+文件名
